...
public class CreatePoolsQueue : MonoBehaviour
{
    ...
    public static CreatePoolsQueue Instance; // bu sýnýfýn tek bir örneðini tutan deðiþken

    //public List<Pool> pools; // havuz listesi
    private Dictionary<string, ObjectPoolQueue<GameObject>> poolDictionary; // stack havuz sözlüðü
    private void Awake()
    {
        ...
        poolDictionary = new Dictionary<string, ObjectPoolQueue<GameObject>>();
    }
    ...
    public void CreatePool(string tag, List<GameObject> prefabs, int size, int capacity)
    {
        ...
        ObjectPoolQueue<GameObject> objectPool = new ObjectPoolQueue<GameObject>(() => {
